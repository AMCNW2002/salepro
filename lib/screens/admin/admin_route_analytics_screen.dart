...
class AdminRouteAnalyticsScreen extends StatelessWidget {
  const AdminRouteAnalyticsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('RouteAnalytics'),
      ...
      builder:
          (
            ...
            for (var shop in shops) {
              routeTotalCustomers[shop.routeId] =
                  (routeTotalCustomers[shop.routeId] ?? 0) + 1;
            }
            ...
            for (var order in orders) {
              ...
              if (order.timestamp.year == now.year &&
                ...
                routeSalesMonthly[rId] =
                    (routeSalesMonthly[rId] ?? 0.0) + order.totalAmount;
              }
              if (now.difference(order.timestamp).inDays <= 7) {
                routeSalesWeekly[rId] =
                    (routeSalesWeekly[rId] ?? 0.0) + order.totalAmount;
              }
            }
            ...
            for (var r in routes) {
              ...
              totalCustomersCovered +=
                  (routeCustomersServed[r.routeId]?.length ?? 0);
            ...
            rankedRoutes.sort(
              (a, b) => (routeSales[b.routeId] ?? 0.0).compareTo(
                routeSales[a.routeId] ?? 0.0,
              ),
            );
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Interactive dashboard for route performance and coverage.',
                  ...
                  _buildCreativeRouteSummaryCards(
                    ...
                    lowestRouteId,
                    routeSales,
                    routeCompletedOrders,
                    routeCustomersServed,
                    activeRoutesCount,
                    totalCustomersCovered,
                    totalRouteSales,
                  ),
                            ...
                            Expanded(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  _buildCreativeCustomerCoverage(
                                    routes,
                                    routeTotalCustomers,
                                    routeCustomersServed,
                                  ),
                            ...
                            Expanded(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  const SizedBox(height: 24),
                                  _buildCreativeRepRouteAssignment(
                                    reps,
                                    routes,
                                    routeSales,
                                    routeCompletedOrders,
  ...
  Widget _buildCreativeRouteSummaryCards(
    ...
    int totalCustomersCovered,
    double totalRouteSales,
  ) {
    String bestSalesName = 'N/A';
    String bestDelName = 'N/A';
    String lowestName = 'N/A';
    try {
      bestSalesName = routes.firstWhere((r) => r.routeId == bestSalesId).name;
    } catch (e) {}
    try {
      bestDelName = routes.firstWhere((r) => r.routeId == bestDelId).name;
    } catch (e) {}
    try {
      lowestName = routes.firstWhere((r) => r.routeId == lowestId).name;
    } catch (e) {}
        ...
        return GridView.count(
          ...
          children: [
            ...
            _buildSleekMetricCard(
              ...
              [Colors.lightBlue.shade300, Colors.lightBlue.shade400],
            ),
            _buildSleekMetricCard(
              'Lowest Route',
              lowestName,
          ...
          if (rankedRoutes.isEmpty)
            ...
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                double perf = totalRouteSales > 0
                    ? (sales / totalRouteSales) * 100
                    : 0.0;

                var rep;
                try {
                  rep = reps.firstWhere((p) => p.routeId == r.routeId);
                } catch (e) {}
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Rep: ${rep?.name ?? 'Unassigned'} • $orders orders',
                              style: TextStyle(
      ...
      child: Column(
        ...
        children: [
          ...
          ...routes.take(3).map((r) {
            ...
            double pct = totalRouteSales > 0
                ? ((sales[r.routeId] ?? 0.0) / totalRouteSales)
                : 0.0;
            return Padding(
  ...
  Widget _buildCreativeCustomerCoverage(
    List<RouteModel> routes,
    Map<String, int> totalCustomers,
    Map<String, Set<String>> servedCustomers,
  ) {
    return Container(
      padding: const EdgeInsets.all(24),
      decoration: BoxDecoration(
      ...
      child: Column(
        ...
        children: [
          ...
          ...activeReps.take(3).map((rep) {
            ...
            try {
              rName = routes.firstWhere((r) => r.routeId == rep.routeId).name;
            } catch (e) {}
